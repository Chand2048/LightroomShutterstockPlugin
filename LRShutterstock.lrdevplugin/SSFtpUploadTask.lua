...
local myLogger = LrLogger( 'shutterstockPluginLog' ) 
...
function SSFtpUploadTask.processRenderedPhotos( functionContext, exportContext )
	...
	for i, rendition in exportContext:renditions{ stopIfCanceled = true } do
		...
		if success then
			...
			if not success then
				...
				rendition:uploadFailed( filename )
